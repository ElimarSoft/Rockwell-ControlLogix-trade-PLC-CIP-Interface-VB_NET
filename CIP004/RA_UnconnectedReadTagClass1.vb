Public Class RA_UnconnectedReadTagClass1
    ...
    Dim Service1 As Byte = RA_Services.CIP_ReadData
    ...
    Public Sub New(TagName As String, ReqElemCount1 As Int16, SessionHandle As Int32, Slot As Byte)
