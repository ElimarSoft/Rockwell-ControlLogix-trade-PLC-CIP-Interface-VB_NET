Public Class ENIP_SendRRDataClass1
    ...
    Public TypeID1 As Int16 = 0
    Public Length1 As Int16 = 0

    Public TypeID2 As Int16 = &HB2
    ...
    Public TimeOutR As Int16 = 32
    Public ItemCountR As Int16 = 2

    Public TypeID1R As Int16 = 0
    Public Length1R As Int16 = 0

    Public TypeID2R As Int16 = &HB2
    Public Length2R As Int16 = 0


    Public Sub New()

        Command = ENIP_Function_Codes.SEND_RR_DATA
    ...
    Public Function Read(Buffer() As Byte) As Byte()
        ...
        If StatusR = 0 Then
            ...
            If (RetLen <> Length2R) Then Return Nothing
