Public Class RA_ConnectedWriteTagClass1
    ...
    Public Sub New(TagName As String, DataType As Int16, DataCount As Int16, DataVal() As Object, SessionHandle As Int32, ConnectionIdentifier As Int32, SequenceCount As Int16)
    ...
    Public Function Read(Buffer() As Byte) As Boolean
        ...
        Return (CIP_DataRequest.StatusR <> 0) Or (CIP_DataRequest.SendUnitData.StatusR <> 0)
